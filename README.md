...
|-------|-------------|-----------|
| **Customer Support Agent** | Customer ticket triage, response, quality review | `.customer-support-agent/` |
| **Steering Policy Maker** | This tool's own policy (self-referential) | `skills/generate/` |
