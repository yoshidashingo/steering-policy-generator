...
**CRITICAL**: When performing any phase, you MUST read and use relevant content from rule detail files in `.steering/steering-rule-details/` directory.
...
1. Load the welcome message from `.steering/steering-rule-details/common/welcome-message.md`
